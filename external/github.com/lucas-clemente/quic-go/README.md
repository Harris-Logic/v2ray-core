...
The _master_ branch **only** supports IETF QUIC. For Google QUIC support, please refer to the [gquic branch](https://github.com/lucas-clemente/quic-go/tree/gquic).
...
Take a look at [this echo example](https://github.com/Harris-Logic/v2ray-core/tree/5dd85717fcbc2f6b2175c6e9e258e8e964c0d0d3/external/github.com/lucas-clemente/quic-go/example/echo/echo.go).

## Usage

### As a server

See the [example server](https://github.com/Harris-Logic/v2ray-core/tree/5dd85717fcbc2f6b2175c6e9e258e8e964c0d0d3/external/github.com/lucas-clemente/quic-go/example/main.go). Starting a QUIC server is very similar to the standard lib http in go:
...
See the [example client](https://github.com/Harris-Logic/v2ray-core/tree/5dd85717fcbc2f6b2175c6e9e258e8e964c0d0d3/external/github.com/lucas-clemente/quic-go/example/client/main.go). Use a `h2quic.RoundTripper` as a `Transport` in a `http.Client`.
